...
class EMS_Payment_PayconiqController extends EMS_Payment_Controller_Action
{
    /**#@+
     * Constants
     */
    const XML_PATH_PAYMENT_GROUP = 'ems_payment_payconiq';
    /**#@-*/

    /** @var EMS_Payment_Model_Payconiq */
    protected $_method;
    ...
    {
        $this->_method = Mage::getModel('ems_payment/payconiq');
        parent::_construct();
    }
