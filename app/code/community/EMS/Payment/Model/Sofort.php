 ...
 * @package     EMS_Payment
 */
class EMS_Payment_Model_Sofort extends EMS_Payment_Model_Abstract
{

    protected $_code = 'ems_payment_sofort';
    protected $_paymentMethod = 'SOFORT';
    protected $_controller = 'sofort';
    ...
    public function createOrder()
    {
        ...
        $emsOrder = $this->_emsLib->createSofortOrder(
