...
class EMS_Payment_CreditcardController extends EMS_Payment_Controller_Action
{
    /**#@+
     * Constants
     */
    const XML_PATH_PAYMENT_GROUP = 'ems_payment_creditcard';
    /**#@-*/

    /** @var EMS_Payment_Model_Creditcard */
    protected $_method;
    ...
    {
        $this->_method = Mage::getModel('ems_payment/creditcard');
        parent::_construct();
    }
