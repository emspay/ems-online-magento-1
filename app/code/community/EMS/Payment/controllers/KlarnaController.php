...
class EMS_Payment_KlarnaController extends EMS_Payment_Controller_Action
{
    /**#@+
     * Constants
     */
    ...
    {
        $this->_method = Mage::getModel('ems_payment/klarna');
        parent::_construct();
    }

    /**
     * Create the order and sets the redirect urls
     *
     * @return void
     */
