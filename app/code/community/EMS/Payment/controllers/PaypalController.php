...
class EMS_Payment_PaypalController extends EMS_Payment_Controller_Action
{
    /**#@+
     * Constants
     */
    const XML_PATH_PAYMENT_GROUP = 'ems_payment_paypal';
    /**#@-*/

    /** @var EMS_Payment_Model_Paypal */
    protected $_method;
    ...
    {
        $this->_method = Mage::getModel('ems_payment/paypal');
        parent::_construct();
    }
