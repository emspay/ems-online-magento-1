...
class EMS_Payment_BancontactController extends EMS_Payment_Controller_Action
{
    /**#@+
     * Constants
     */
    const XML_PATH_PAYMENT_GROUP = 'ems_payment_bancontact';
    /**#@-*/

    /** @var EMS_Payment_Model_Bancontact */
    protected $_method;
    ...
    {
        $this->_method = Mage::getModel('ems_payment/bancontact');
        parent::_construct();
    }
