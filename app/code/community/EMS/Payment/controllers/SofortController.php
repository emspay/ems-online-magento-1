...
class EMS_Payment_SofortController extends EMS_Payment_Controller_Action
{
    /**#@+
     * Constants
     */
    const XML_PATH_PAYMENT_GROUP = 'ems_payment_sofort';
    /**#@-*/

    /** @var EMS_Payment_Model_Sofort */
    protected $_method;
    ...
    {
        $this->_method = Mage::getModel('ems_payment/sofort');
        parent::_construct();
    }
