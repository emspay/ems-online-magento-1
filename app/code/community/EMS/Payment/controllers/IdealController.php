...
class EMS_Payment_IdealController extends EMS_Payment_Controller_Action
{
    /**#@+
     * Constants
     */
    const XML_PATH_PAYMENT_GROUP = 'ems_payment_ideal';
    /**#@-*/

    /** @var EMS_Payment_Model_Ideal */
    protected $_method;
    ...
    {
        $this->_method = Mage::getModel('ems_payment/ideal');
        parent::_construct();
    }
